                ...
                for (int i = 0; i < eventCount; i++)
                {
                    ...
                    bin.StepIn(eventBodyOffset);
                    {
                        ...
                        bin.StepIn(eventParamOffset);
                        {
                            switch (eventType)
                            {
                                case TimeActEventType.Type000: var newType0 = new Tae000() { Index = i, StartTime = startTime, EndTime = endTime }; newType0.ReadParameters(bin); anim.EventList.Events000.Add(newType0); break;
                                case TimeActEventType.Type001: var newType1 = new Tae001() { Index = i, StartTime = startTime, EndTime = endTime }; newType1.ReadParameters(bin); anim.EventList.Events001.Add(newType1); break;
                                case TimeActEventType.Type002: var newType2 = new Tae002() { Index = i, StartTime = startTime, EndTime = endTime }; newType2.ReadParameters(bin); anim.EventList.Events002.Add(newType2); break;
                                case TimeActEventType.Type005: var newType5 = new Tae005() { Index = i, StartTime = startTime, EndTime = endTime }; newType5.ReadParameters(bin); anim.EventList.Events005.Add(newType5); break;
                                case TimeActEventType.Type008: var newType8 = new Tae008() { Index = i, StartTime = startTime, EndTime = endTime }; newType8.ReadParameters(bin); anim.EventList.Events008.Add(newType8); break;
                                case TimeActEventType.Type016: var newType16 = new Tae016() { Index = i, StartTime = startTime, EndTime = endTime }; newType16.ReadParameters(bin); anim.EventList.Events016.Add(newType16); break;
                                case TimeActEventType.Type024: var newType24 = new Tae024() { Index = i, StartTime = startTime, EndTime = endTime }; newType24.ReadParameters(bin); anim.EventList.Events024.Add(newType24); break;
                                case TimeActEventType.Type032: var newType32 = new Tae032() { Index = i, StartTime = startTime, EndTime = endTime }; newType32.ReadParameters(bin); anim.EventList.Events032.Add(newType32); break;
                                case TimeActEventType.Type033: var newType33 = new Tae033() { Index = i, StartTime = startTime, EndTime = endTime }; newType33.ReadParameters(bin); anim.EventList.Events033.Add(newType33); break;
                                case TimeActEventType.Type064: var newType64 = new Tae064() { Index = i, StartTime = startTime, EndTime = endTime }; newType64.ReadParameters(bin); anim.EventList.Events064.Add(newType64); break;
                                case TimeActEventType.Type065: var newType65 = new Tae065() { Index = i, StartTime = startTime, EndTime = endTime }; newType65.ReadParameters(bin); anim.EventList.Events065.Add(newType65); break;
                                case TimeActEventType.Type066: var newType66 = new Tae066() { Index = i, StartTime = startTime, EndTime = endTime }; newType66.ReadParameters(bin); anim.EventList.Events066.Add(newType66); break;
                                case TimeActEventType.Type067: var newType67 = new Tae067() { Index = i, StartTime = startTime, EndTime = endTime }; newType67.ReadParameters(bin); anim.EventList.Events067.Add(newType67); break;
                                case TimeActEventType.Type096: var newType96 = new Tae096() { Index = i, StartTime = startTime, EndTime = endTime }; newType96.ReadParameters(bin); anim.EventList.Events096.Add(newType96); break;
                                case TimeActEventType.Type099: var newType99 = new Tae099() { Index = i, StartTime = startTime, EndTime = endTime }; newType99.ReadParameters(bin); anim.EventList.Events099.Add(newType99); break;
                                ...
                                case TimeActEventType.Type128: var newType128 = new Tae128() { Index = i, StartTime = startTime, EndTime = endTime }; newType128.ReadParameters(bin); anim.EventList.Events128.Add(newType128); break;
